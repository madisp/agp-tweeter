...
val cache = VersionsStore(FileStore(Paths.get("/tmp/agp-tweeter")), moshi)

val db = VersionsStore(DynamoStore(DynamoDB(AmazonDynamoDBClient()).getTable("agp-tweeter")), moshi)
...
class PopulateHandler: RequestHandler<Input, String> {
  ...
  val oldAgpVersions = listOf("0.1", "0.10.0", "0.10.1", "0.10.2", "0.10.4", "0.11.0", "0.11.1", "0.11.2", "0.12.0", "0.12.1", "0.12.2",
  ...
  val oldSupportLibVersions = listOf("13.0.0", "20.0.0", "22.1.0", "23.0.1", "23.3.0", "24.0.0-beta1", "25.0.0", "25.3.0", "18.0.0", "21.0.0", "22.1.1",
